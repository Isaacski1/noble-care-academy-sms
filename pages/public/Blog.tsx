...
const posts = [
  {
    ...
    readTime: "5 min read",
    image: "/blog-digital-management.jpg",
    icon: BookOpen,
    accent: "#93C5FD",
    featured: true,
  ...
  },
  {
    ...
    author: "School Manager GH Team",
    readTime: "4 min read",
    image: "/blog-parent-dashboard.jpg",
    icon: Users,
    accent: "#86EFAC",
    featured: true,
  ...
  },
  {
    ...
    author: "School Manager GH Team",
    readTime: "6 min read",
    image: "/blog-cloud-vs-premise.jpg",
    icon: Shield,
    accent: "#C4B5FD",
    featured: false,
